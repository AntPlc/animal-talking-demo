...
export interface NpcProfile {
  ...
  personality: string[];
  // Leisure interests and pastimes used as conversational cues in dialogue generation.
  hobbies: string[];
...
export const NPC_PROFILES: NpcProfile[] = [
  {
    ...
    hobbies: ["keep the boutique stocked", "help residents find the right item"],
  ...
  },
  {
    ...
    hobbies: ["check the flower beds", "protect the park"],
  ...
  },
  {
    ...
    hobbies: ["scan the town for useful news", "meet everyone once"],
  ...
  },
  {
    ...
    hobbies: ["inspect broken tools", "help with repairs"],
    preferredZoneId: "market",
    lore:
  ...
  },
  {
    ...
    hobbies: ["restock the morning shelves", "share a fresh recipe", "make every newcomer feel at home"],
    preferredZoneId: "market",
    lore:
  ...
  },
  {
    ...
    hobbies: ["check the pond path", "keep everyone safe", "not let his fear show"],
  ...
  },
  {
    ...
    hobbies: ["shame anyone talking too loud in the stacks", "correct bad takes about books in public"],
  ...
  },
  {
    ...
    hobbies: ["find a place to perform", "lift the town mood", "make someone's day a little more interesting"],
    preferredZoneId: "plaza",
    lore:
